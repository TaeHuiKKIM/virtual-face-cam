...
### OBS 없이, 가상 카메라 없이 이미지/슬라이드쇼만 띄우고 싶다

아래 macOS 전용 앱을 쓰세요. 설치가 더 단순하고 OBS가 필요 없습니다.

https://github.com/TaeHuiKKIM/virtual-face-cam-mac

단, 이 앱은 Zoom/Teams의 카메라 목록에는 나타나지 않습니다. 화면 공유용입니다.
...
OBS 없이 이미지를 전체 화면으로 띄우는 용도라면 아래 앱을 사용하세요.
